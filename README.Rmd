...
```{r, echo=F}
#In version 0.3.0 the multi and event tibbles are not filtered by state
myFARS$multi_acc <- filter(myFARS$multi_acc, state=="Virginia")
myFARS$multi_veh <- filter(myFARS$multi_veh, state=="Virginia")
myFARS$multi_per <- filter(myFARS$multi_per, state=="Virginia")
myFARS$events <- filter(myFARS$events, state=="Virginia")
```
