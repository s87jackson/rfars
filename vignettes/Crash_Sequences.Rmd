...
`FALSE`, (the default) R will ask your permission before downloading files. For 
simplicity, we will import one year of data for one state.

```{r, warning=FALSE}
get_fars(years = 2020, states = "VA", proceed=TRUE)
```
